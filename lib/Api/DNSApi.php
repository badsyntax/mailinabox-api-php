...
class DNSApi
{
    ...
    /**
     * Operation getDnsZonefile
     *
     * Get DNS zonefile
     *
     * @param  string $zone Hostname (required)
     *
     * @throws \MailInABoxAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|string
     */
    public function getDnsZonefile($zone)
    {
        list($response) = $this->getDnsZonefileWithHttpInfo($zone);
        return $response;
    }

    /**
     * Operation getDnsZonefileWithHttpInfo
     *
     * Get DNS zonefile
     *
     * @param  string $zone Hostname (required)
     ...
     */
    public function getDnsZonefileWithHttpInfo($zone)
    {
        $request = $this->getDnsZonefileRequest($zone);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDnsZonefileAsync($zone)
    {
        return $this->getDnsZonefileAsyncWithHttpInfo($zone)->then(function (
            $response
        ) {
            return $response[0];
        });
    ...
    /**
     * Operation getDnsZonefileAsyncWithHttpInfo
     *
     * Get DNS zonefile
     *
     * @param  string $zone Hostname (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDnsZonefileAsyncWithHttpInfo($zone)
    {
        $returnType = 'string';
        $request = $this->getDnsZonefileRequest($zone);
    ...
    /**
     * Create request for operation 'getDnsZonefile'
     *
     * @param  string $zone Hostname (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getDnsZonefileRequest($zone)
    {
        // verify the required parameter 'zone' is set
        if ($zone === null || (is_array($zone) && count($zone) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $zone when calling getDnsZonefile'
            );
        }

        $resourcePath = '/dns/zonefile/{zone}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
