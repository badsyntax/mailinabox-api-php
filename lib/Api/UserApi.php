...
class UserApi
{
     ...
     * @return \MailInABoxAPI\Client\Model\MeResponse
     */
     ...
     * @throws \MailInABoxAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailInABoxAPI\Client\Model\MeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMeWithHttpInfo()
    {
        ...
        try {
            ...
            $returnType = '\MailInABoxAPI\Client\Model\MeResponse';
            $responseBody = $response->getBody();
    ...
    {
        return $this->getMeAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
