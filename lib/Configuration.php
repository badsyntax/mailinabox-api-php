...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://box.example.com/admin';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/0.51.1/PHP';
    ...
    {
        $report = 'PHP SDK (MailInABoxAPI\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 0.51.0' . PHP_EOL;
        $report .= '    SDK Package Version: 0.51.1' . PHP_EOL;
        $report .=
            '    Temp Folder Path: ' .
    ...
    public function getHostFromSettings($index, $variables = null)
    {
        ...
        if ($index < 0 || $index >= sizeof($hosts)) {
            throw new \InvalidArgumentException(
                "Invalid index $index when selecting the host. Must be less than " .
                    sizeof($hosts)
            );
        }
        ...
        foreach ($host['variables'] as $name => $variable) {
            if (array_key_exists($name, $variables)) {
                ...
                if (in_array($variables[$name], $variable['enum_values'])) {
