...
/**
 * DNSDumpDomainRecord Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DNSDumpDomainRecord implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DNSDumpDomainRecord';
    ...
    {
        $this->container['explanation'] = isset($data['explanation'])
            ? $data['explanation']
            : null;
     ...
     * Gets rtype
     *
     * @return \MailInABoxAPI\Client\Model\DNSRecordType|null
     */
     ...
     * Sets rtype
     *
     * @param \MailInABoxAPI\Client\Model\DNSRecordType|null $rtype rtype
     *
     * @return $this
     */
