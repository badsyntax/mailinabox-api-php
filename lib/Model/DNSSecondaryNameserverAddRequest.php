...
/**
 * DNSSecondaryNameserverAddRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class DNSSecondaryNameserverAddRequest implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DNSSecondaryNameserverAddRequest';
    ...
    {
        $this->container['hostnames'] = isset($data['hostnames'])
            ? $data['hostnames']
            : null;
    }
     ...
     * Sets hostnames
     *
     * @param string $hostnames Hostnames separated with commas or spaces.
     *
     * @return $this
     */
