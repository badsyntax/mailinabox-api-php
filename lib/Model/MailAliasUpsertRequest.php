...
class MailAliasUpsertRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets forwardsTo
     *
     * @param string $forwardsTo If adding a regular or catch-all alias, the format needs to be `user@example.com`. Multiple address can be separated by newlines or commas.  If adding a domain alias, the format needs to be `@example.com`.
     *
     * @return $this
     */
