 ...
 * @link     https://openapi-generator.tech
 */
class MailUser implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MailUser';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\MailInABoxAPI\Client\Model\MailUserStatus',
        'mailbox' => 'string',
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['status'] = isset($data['status'])
            ? $data['status']
            : null;
        $this->container['mailbox'] = isset($data['mailbox'])
            ? $data['mailbox']
            : null;
    }
     ...
     * Sets privileges
     *
     * @param \MailInABoxAPI\Client\Model\MailUserPrivilege[] $privileges privileges
     *
     * @return $this
     */
     ...
     * Gets status
     *
     * @return \MailInABoxAPI\Client\Model\MailUserStatus
     */
     ...
     * Sets status
     *
     * @param \MailInABoxAPI\Client\Model\MailUserStatus $status status
     *
     * @return $this
     */
     ...
     * Sets mailbox
     *
     * @param string|null $mailbox mailbox
     *
     * @return $this
     */
