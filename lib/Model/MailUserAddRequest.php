...
/**
 * MailUserAddRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class MailUserAddRequest implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MailUserAddRequest';
    ...
    public function __construct(array $data = null)
    {
        $this->container['email'] = isset($data['email'])
            ? $data['email']
            : null;
        $this->container['password'] = isset($data['password'])
            ? $data['password']
            : null;
