...
/**
 * SSLCSRGenerateRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class SSLCSRGenerateRequest implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SSLCSRGenerateRequest';
    ...
    {
        $this->container['countrycode'] = isset($data['countrycode'])
            ? $data['countrycode']
            : null;
    }
