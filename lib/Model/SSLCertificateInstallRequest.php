...
/**
 * SSLCertificateInstallRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class SSLCertificateInstallRequest implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SSLCertificateInstallRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['chain'] = isset($data['chain'])
            ? $data['chain']
            : null;
    }
     ...
     * Sets cert
     *
     * @param string $cert TLS/SSL certificate.
     *
     * @return $this
     */
     ...
     * Sets chain
     *
     * @param string $chain TLS/SSL intermediate chain (if provided, else empty string).
     *
     * @return $this
     */
